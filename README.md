...
<title>Monopoly Químico Profesional</title>
<style>
body { 
...
function actualizarPropiedades(){
    ...
    jugadores.forEach(j => {
        ...
        propiedadesDiv.appendChild(container);
    });
}
...
function calcularRenta(casilla){
    ...
    let rentaBase = casilla.alquiler;
